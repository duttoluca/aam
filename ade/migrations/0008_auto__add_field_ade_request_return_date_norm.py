...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ADE_request.return_date_norm'
        db.add_column(u'ade_ade_request', 'return_date_norm',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ADE_request.return_date_norm'
        db.delete_column(u'ade_ade_request', 'return_date_norm')
    ...
    models = {
        ...
        u'ade.ade_request': {
            ...
            'return_date_norm': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
