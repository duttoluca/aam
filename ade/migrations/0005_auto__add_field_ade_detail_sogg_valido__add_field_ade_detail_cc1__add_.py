...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ADE_detail.sogg_valido'
        db.add_column('ade_ade_detail', 'sogg_valido',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1, blank=True),
                      keep_default=False)

        # Adding field 'ADE_detail.cc1'
        db.add_column('ade_ade_detail', 'cc1',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1, blank=True),
                      keep_default=False)

        # Adding field 'ADE_detail.cc2'
        db.add_column('ade_ade_detail', 'cc2',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ADE_detail.sogg_valido'
        db.delete_column('ade_ade_detail', 'sogg_valido')

        # Deleting field 'ADE_detail.cc1'
        db.delete_column('ade_ade_detail', 'cc1')

        # Deleting field 'ADE_detail.cc2'
        db.delete_column('ade_ade_detail', 'cc2')
